...
const WRITE_SITES: &[WriteSite] = &[
    ...
    WriteSite {
        ...
        reason: "Gated by allowlist_permits(\"runtime_pm\", hwid_from_attr_path(path), …) at actuator.rs; default-deny + audit on Deny.",
    },
    WriteSite {
        file: "src/actuator.rs",
        line: 856,
    ...
    WriteSite {
        ...
        classification: "allowlist",
        reason: "Gated by allowlist_permits(\"pci_aspm\", hwid_from_device_dir(device_dir), …); default-deny + audit on Deny.",
    },
    WriteSite {
        file: "src/actuator.rs",
        line: 1042,
    ...
    WriteSite {
        ...
        classification: "allowlist",
        reason: "Gated by allowlist_permits(\"sata_alpm\", hwid_from_ancestors(host_dir), …); default-deny + audit on Deny.",
    },
    WriteSite {
        file: "src/actuator.rs",
        line: 1118,
    ...
    WriteSite {
        ...
        classification: "allowlist",
        reason: "Gated by allowlist_permits(\"backlight\", hwid_from_ancestors(device_dir), …); default-deny + audit on Deny.",
    },
    WriteSite {
        file: "src/actuator.rs",
        line: 1200,
        function: "Actuator::revert_key (rpm control)",
        classification: "revert-path",
        reason: "Reverts power/control to journaled original on context change; first-write was allowlist-gated by Action::RuntimePm.",
    },
    WriteSite {
        file: "src/actuator.rs",
        line: 1206,
        function: "Actuator::revert_key (rpm delay)",
        classification: "revert-path",
        reason: "Reverts power/autosuspend_delay_ms to journaled original on context change; first-write was allowlist-gated by Action::RuntimePm.",
    },
    WriteSite {
        file: "src/actuator.rs",
        line: 1242,
        function: "Actuator::revert_key (device latency PM QoS)",
        classification: "revert-path",
        reason: "Reverts per-device PM QoS resume latency to journaled original on context change; first-write was allowlist-gated by Action::DeviceResumeLatency.",
    },
    WriteSite {
        file: "src/actuator.rs",
        line: 1275,
        function: "Actuator::revert_key (aspm/alpm/backlight)",
        classification: "revert-path",
        reason: "Reverts link/l1_aspm, link_power_management_policy, or brightness to journaled original on context change; first-write was allowlist-gated by Action::PcieAspm / Action::SataAlpm / Action::Backlight.",
    },
