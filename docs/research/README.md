...
Research records possibilities and evidence; it does not override an accepted
...
- [0004 — Telemetry fidelity](0004-telemetry-fidelity-rca-and-architecture.md)
- [0005 — Focus versus resource pull](0005-focus-vs-resource-pull.md)
- [0006 — Hardware allowlist design](0006-hw-allowlist-db-design.md)
- [0007 — Display power](0007-display-panel-backlight-psr-vrr-dpms.md)
- [0008 — NVMe, PCIe, and SATA power](0008-nvme-apst-pcie-aspm-sata-alpm.md)
- [0009 — Runtime PM autosuspend](0009-runtime-pm-autosuspend-policy.md)
- [0010 — PPD and GameMode compatibility](0010-ppd-gamemode-dbus-shim.md)
- [0011 — dGPU runtime PM and MUX](0011-dgpu-runtime-pm-and-mux.md)
- [0012 — DTPM powercap outer loop](0012-dtpm-powercap-outer-loop.md)
- [0013 — Thermal and fan coupling](0013-thermal-fan-budget-coupling.md)
- [0014 — `sched_ext` selection](0014-sched-ext-selector-per-workload-class.md)
- [0015 — zram and MGLRU](0015-zram-mglru-tuning-per-ram-tier.md)
- [0016 — mkosi snapshot pinning](0016-mkosi-ala-snapshot-pinning.md)
- [0017 — UKI signing and Secure Boot](0017-uki-signing-secure-boot-enrollment.md)
